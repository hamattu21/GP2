<?php
  ...
  include '../db/db.php';
  session_start();
  $query = "SELECT * FROM POST P WHERE P.USER_ID = ".$_SESSION['id'];
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-green bold uppercase">My Posts</span>
                                                </div>
                                                  ...
                                                  <?php
                                                    if(@count($array) > 0){
                                                      ...
                                                      <div class="alert alert-danger">
                                                          <strong>Note!</strong> You Dont Have Any Post
                                                      </div>
                                                      <?php
                                                    }
