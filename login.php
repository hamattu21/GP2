...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="" action="Ctrl/loginCtrl.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="username" required/>
                </div>
                <div class="form-group">
