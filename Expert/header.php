...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link href="../res/assets/apps/css/todo-2-rtl.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="../res/assets/layouts/layout5/css/layout-rtl.min.css" rel="stylesheet" type="text/css" />
        <link href="../res/assets/layouts/layout5/css/custom-rtl.min.css" rel="stylesheet" type="text/css" />
